...
class kalman_Filter:
	...
	def mag_raw_data(self, msg):
		self.mag_data = msg
                ...
                self.mag_x = float(self.mag_data.magnetic_field.x +583.458774038)
                self.mag_y = float(self.mag_data.magnetic_field.y -267.402764423)
                self.mag_z = float(self.mag_data.magnetic_field.z + 282.935036058)
                """
                self.mag_x = float(self.mag_data.magnetic_field.y -267.402764423)
                self.mag_y = float(self.mag_data.magnetic_field.x +583.458774038)
                self.mag_z = float(self.mag_data.magnetic_field.z + 282.935036058)
                """
	def __init__(self):
