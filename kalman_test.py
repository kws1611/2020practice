...
class kalman_Filter:
        ...
        def kalman(self):
                ...
                if (self.Xp[1,0] - self.Z[1,0])>1 or (self.Xp[1,0] - self.Z[1,0])< -1:
                        ...
                        print("Z")
                        print(self.Z)
                if (self.Xp[2,0] - self.Z[2,0])>1 or (self.Xp[2,0] - self.Z[2,0])< -1:
                        print("X")
                        print(self.X)
                        print("Z")
                        print(self.Z)

                if (self.Xp[3,0] - self.Z[3,0])>1 or (self.Xp[3,0] - self.Z[3,0])< -1:
                        print("X")
                        print(self.X)
                        print("Z")
                        print(self.Z)
                ...
                #self.X = np.matrix([-self.X[0,0],self.X[1,0],self.X[2,0],self.X[3,0]])
                #self.X = self.X.T
                self.rate.sleep()
