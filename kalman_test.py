...
class kalman_Filter:
	...
	def mag_raw_data(self, msg):
		self.mag_data = msg
                ...
                """
                self.mag_x = (self.mag_data.magnetic_field.x +583.458774038) * 583.458774038/(+583.458774038**2 + 267.402764423**2 + 282.935036058**2)
                self.mag_y = (self.mag_data.magnetic_field.y -267.402764423) * (-267.402764423) / (+583.458774038**2 + 267.402764423**2 + 282.935036058**2)
                self.mag_z = (self.mag_data.magnetic_field.z + 282.935036058) * 282.935036058/(+583.458774038**2 + 267.402764423**2 + 282.935036058**2)
                """
                self.mag_x = (self.mag_data.magnetic_field.y -self.mag_bias_y) * (self.mag_bias_y) / (self.mag_bias_x**2 + self.mag_bias_y**2 + self.mag_bias_z**2)
                self.mag_y = (self.mag_data.magnetic_field.x -self.mag_bias_x) * self.mag_bias_x/(self.mag_bias_x**2 + self.mag_bias_y**2 + self.mag_bias_z**2)
                self.mag_z = -(self.mag_data.magnetic_field.z -self.mag_bias_z) * self.mag_bias_z/(self.mag_bias_x**2 + self.mag_bias_y**2 + self.mag_bias_z**2)
